...
import "package:educational_app/bloc_observer.dart";
import "package:educational_app/constants.dart";
import "package:educational_app/core/functions/service_locator.dart";
import "package:educational_app/core/nertwork/cacheNetwork.dart";
import "package:educational_app/core/utilies/api_keys.dart";
...
import "package:educational_app/features/splash_screen/presentation/views/splash_view.dart";
    ...
    return ScreenUtilInit(
      ...
      child: MultiBlocProvider(
        providers: [
         ...
         BlocProvider(
            create: (context) => FavCubit(getIt.get<HomeRepoImpl>() as HomeRepo),
          ),
        ],
        child: MaterialApp(
